<?php
    ...
    if($DADOS_CLIENTE[0]['usa_xml'] == false){
        ...
        //Validar CPF CNPJ
            ...
            xmlwriter_write_attribute($XW, 'xmlns', 'https://www.bcb.gov.br/PAG/PAG0202.xsd');  //Substituir pelo arquivo correto 
            ...
            xmlwriter_start_element($XW, 'PAG0202'); //Substituir pelo serviço correto
