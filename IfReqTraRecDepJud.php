<?php
    ...
    error_reporting(E_ALL);k

    $POST = file_get_contents('php://input');l
    ...
    if($DADOS_CLIENTE[0]['usa_xml'] == false){
        ...
        if($camposValidos){
            ...
            */
            ...
            xmlwriter_start_element($XW, 'PAG0121');
            ...
            $BIBLIOTECA->Geracao()->criaElementoSimplesXML($XW, 'IdentcDep', $_POST['IdentcDep']);
